...
| 19 | Personas — named presets over the personalization axes (design: `docs/persona-page.md`) | **Slices 1-7 implemented; model-specific lore baselines, TTS voice, and preferred pattern tags remain open** | — |
