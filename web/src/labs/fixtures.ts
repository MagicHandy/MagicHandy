...
export function labState():LLMLabState {return {current:{...initialFlow},turns:[],revision:0,busy:false,prompts:{layered:"layered-prompt",creative_v2:"gesture-prompt",stroke_ends:"ends-prompt",groove:"groove-prompt",plain_words:"plain-prompt",edits:"edit-prompt",controls:"control-prompt",sequence:"sequence-prompt",layers:"layer-prompt",library:"library-prompt",library_descriptive:"descriptive-prompt",library_actions:"actions-prompt"},model:"local-model",settings_key:"saved-limits",limits:labLimits};}
