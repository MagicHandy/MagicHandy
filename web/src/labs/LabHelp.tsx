  ...
  return <section className="lab-help-page">
    ...
    <article className="lab-help-content"><h2 ref={heading} tabIndex={-1}>{labels[topics.indexOf(topic)]}</h2>
      ...
      {topic==="modes"&&<>
        ...
        <p>{t("Creative v2 develops reach and timing continuously across 64 cycles. Mixed focus moves through intermediate widths; it does not schedule local and full-stroke blocks. Rebounds contract and recover within that flow. Inertia shapes travel, not impacts. The finite realization repeats until evolved; safety limits still apply.")}</p>
      </>}
      {topic==="autopilot"&&<>
