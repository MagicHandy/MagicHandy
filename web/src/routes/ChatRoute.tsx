...
export function ChatRoute() {
  ...
  const motionMode = savedMotionMode === "dynamic" || savedMotionMode === "pattern" || savedMotionMode === "layered" || savedMotionMode === "off"
    ? savedMotionMode
  ...
  async function changeMotionMode(mode: "dynamic" | "pattern" | "layered" | "off") {
