...
const sameValueAllowed = {
  es: new Set(["FFmpeg", "CRF {value}", "{rate} kbps", "{count} tokens", "{count} videos", "{rounding} ms", "{seconds} s", "{size} / {location}", "{state}: {message}", "1 video", "Autopilot", "Chat", "Commit", "Error", "Esc", "Funscript", "General", "Intiface Central", "local / {owner}", "MagicHandy", "Normal", "Original", "script", "Vagina / vulva", "Video", "Videos", "Vulnerable"]),
  "pt-BR": new Set(["FFmpeg", "CRF {value}", "{rate} kbps", "{count} tokens", "{rounding} ms", "{seconds} s", "{size} / {location}", "{state}: {message}", "Autopilot", "Chat", "Commit", "Esc", "Funscript", "Interface", "Intiface Central", "local / {owner}", "MagicHandy", "Normal", "Original", "script", "Status", "Tags", "Vagina / vulva"]),
