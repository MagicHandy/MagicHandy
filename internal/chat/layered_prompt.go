...
Use one geometry edit for coupled reach/location changes. It preserves speed and existing pace variation:
...
User: keep varying / AUTOPILOT VARIATION
...
Independent refinements, only when requested:
...
- evolve:true refreshes seeded variation and timing without replacing any geometry, widths, speed or layers. Automatic continuation should evolve. Exact repetition/no-change requests override automatic evolution.
