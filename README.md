...
[Download](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.44)
...
> Windows build is `v0.1.0-alpha.44` and remains unsigned.
...
[latest release](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.44):
