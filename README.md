...
[Download](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.29)
...
> Windows build is `v0.1.0-alpha.29` and remains unsigned.
...
[latest release](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.29):
