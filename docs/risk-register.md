...
- require `ReviewedUnsignedPublic` plus Microsoft's completed false-positive
  case ID and the explicitly approved alpha.8 through alpha.11, alpha.13, alpha.14, alpha.15, and alpha.16 versions for unsigned setup
...
through alpha.11, alpha.13, alpha.14, alpha.15, and alpha.16, withdrawn portable-only alpha.12, and timestamped
