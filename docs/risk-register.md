...
- require `ReviewedUnsignedPublic` plus Microsoft's completed false-positive
  case ID and the explicitly approved alpha.8 through alpha.11 and alpha.13 through alpha.21 versions for unsigned setup
...
through alpha.11 and alpha.13 through alpha.21, withdrawn portable-only alpha.12, and timestamped
