...
reviewed alpha.14 through alpha.30 package-preserving releases.
...
3. **Alpha.8 through alpha.11 and alpha.13 through alpha.30 reviewed unsigned
   ...
   perceptual phrase context, and deadline presentation. None changes installer
...
- `Test-WindowsRelease.ps1 -ArtifactPolicy ReviewedUnsignedPublic` requires an
  alpha.8 through alpha.11 or alpha.13 through alpha.30 version, the recorded
...
- Alpha.9 through alpha.11 and alpha.13 through alpha.30 reviewed setup
