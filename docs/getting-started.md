...
[v0.1.0-alpha.22](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.22).
...
and removed the alpha.6 detection. Alpha.21 explicitly extends the reviewed
