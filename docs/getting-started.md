...
[v0.1.0-alpha.24](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.24).
...
and removed the alpha.6 detection. Alpha.24 explicitly extends the reviewed
