...
[v0.1.0-alpha.34](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.34).
...
and removed the alpha.6 detection. Alpha.34 explicitly extends the reviewed
