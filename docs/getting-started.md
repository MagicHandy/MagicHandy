...
[v0.1.0-alpha.33](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.33).
...
and removed the alpha.6 detection. Alpha.33 explicitly extends the reviewed
