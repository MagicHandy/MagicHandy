...
[v0.1.0-alpha.36](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.36).
...
and removed the alpha.6 detection. Alpha.36 explicitly extends the reviewed
