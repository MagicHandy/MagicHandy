...
[v0.1.0-alpha.23](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.23).
...
and removed the alpha.6 detection. Alpha.23 explicitly extends the reviewed
