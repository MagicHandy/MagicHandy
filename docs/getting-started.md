...
[v0.1.0-alpha.35](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.35).
...
and removed the alpha.6 detection. Alpha.35 explicitly extends the reviewed
