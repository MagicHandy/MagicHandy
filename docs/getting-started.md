...
[v0.1.0-alpha.27](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.27).
...
and removed the alpha.6 detection. Alpha.27 explicitly extends the reviewed
