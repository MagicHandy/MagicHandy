...
[v0.1.0-alpha.32](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.32).
...
and removed the alpha.6 detection. Alpha.32 explicitly extends the reviewed
