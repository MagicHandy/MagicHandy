...
[v0.1.0-alpha.31](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.31).
...
and removed the alpha.6 detection. Alpha.31 explicitly extends the reviewed
