...
[v0.1.0-alpha.50](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.50).
...
and removed the alpha.6 detection. Alpha.50 explicitly extends the reviewed
