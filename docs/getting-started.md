...
[v0.1.0-alpha.29](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.29).
...
and removed the alpha.6 detection. Alpha.29 explicitly extends the reviewed
