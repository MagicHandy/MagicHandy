...
[v0.1.0-alpha.49](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.49).
...
and removed the alpha.6 detection. Alpha.49 explicitly extends the reviewed
