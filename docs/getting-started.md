...
[v0.1.0-alpha.37](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.37).
...
and removed the alpha.6 detection. Alpha.37 explicitly extends the reviewed
