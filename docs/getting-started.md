...
[v0.1.0-alpha.30](https://github.com/MagicHandy/MagicHandy/releases/tag/v0.1.0-alpha.30).
...
and removed the alpha.6 detection. Alpha.30 explicitly extends the reviewed
