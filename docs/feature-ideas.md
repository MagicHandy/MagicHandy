...
| **Program section clipping + bookmarks** (Settings tour: "Program section clipping"; funscript timeline crop with device preview, history 2026-04-23) | **Partial.** MagicHandy imports bounded funscripts; a timeline **clip-on-import with play-this-selection preview** and named section bookmarks are not built. Worth scoping with the library UI. |
