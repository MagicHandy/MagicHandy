...
ADR 0014 therefore permits alpha.8 through alpha.11, alpha.13, alpha.14, and alpha.15 setup
publication through a dedicated policy bound to those versions and case.
Alpha.9 through alpha.11, alpha.13, alpha.14, and alpha.15 also add a Defender scan of the exact
...
`ReviewedUnsignedPublic` accepts only alpha.8 through alpha.11, alpha.13, alpha.14, and alpha.15 with
