...
ADR 0014 therefore permits alpha.8 through alpha.11, alpha.13, alpha.14, alpha.15, and alpha.16 setup
publication through a dedicated policy bound to those versions and case.
Alpha.9 through alpha.11, alpha.13, alpha.14, alpha.15, and alpha.16 also add a Defender scan of the exact
...
quality, installer-policy, Defender, and exact setup lifecycle gates pass.
...
directory. The exact setup then receives lifecycle verification:
...
`ReviewedUnsignedPublic` accepts only alpha.8 through alpha.11, alpha.13, alpha.14, alpha.15, and alpha.16 with
...
three explicit paths. No wildcard publishes a release asset. Prerelease tags
