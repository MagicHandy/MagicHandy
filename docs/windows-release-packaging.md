...
ADR 0014 therefore permits alpha.8 through alpha.11 and alpha.13 through alpha.24 setup
publication through a dedicated policy bound to those versions and case.
Alpha.9 through alpha.11 and alpha.13 through alpha.24 also add a Defender scan of the exact
...
`ReviewedUnsignedPublic` accepts only alpha.8 through alpha.11 and alpha.13 through alpha.24 with
