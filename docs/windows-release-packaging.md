...
alpha.50 setup publication through a dedicated policy bound to those versions
and case. Alpha.9 through alpha.11 and alpha.13 through alpha.50 also add a
...
through alpha.50 with the recorded Microsoft case ID and checks the x64 unsigned
